...
RcppExport SEXP _EMDE_FSEM(SEXP group_numSEXP, SEXP prior_wightSEXP, SEXP CSEXP, SEXP w_reduceSEXP, SEXP w0_reduceSEXP, SEXP x_reduceSEXP, SEXP x_reduce_intSEXP, SEXP reduce_numSEXP, SEXP theta_oldSEXP, SEXP k_stepSEXP, SEXP newtown_stepSEXP, SEXP cut_maxSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _EMDE_compute_pl(SEXP thetaSEXP, SEXP xSEXP, SEXP reduce_numSEXP, SEXP alphaSEXP, SEXP group_numSEXP, SEXP CSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _EMDE_homo_opt(SEXP w_reduceSEXP, SEXP x_reduceSEXP, SEXP reduce_numSEXP, SEXP newtown_stepSEXP, SEXP thSEXP, SEXP rSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _EMDE_reduce_w(SEXP wSEXP, SEXP reduce_numSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_EMDE_FSEM", (DL_FUNC) &_EMDE_FSEM, 12},
    {"_EMDE_compute_pl", (DL_FUNC) &_EMDE_compute_pl, 6},
    {"_EMDE_homo_opt", (DL_FUNC) &_EMDE_homo_opt, 6},
    {"_EMDE_reduce_w", (DL_FUNC) &_EMDE_reduce_w, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_EMDE(DllInfo *dll) {
